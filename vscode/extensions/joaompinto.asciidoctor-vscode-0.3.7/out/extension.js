...
function activate(context) {
    ...
    */
    ...
    var contentProvider = new previewContentProvider_1.MDDocumentContentProvider(engine, logger);
    var contentProviderRegistration = vscode.workspace.registerTextDocumentContentProvider('asciidoc', contentProvider);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('asciidoc.showPreviewToSide', function (uri) { return showPreview(uri, true); }));
    context.subscriptions.push(vscode.commands.registerCommand('asciidoc.showSource', showSource));
    context.subscriptions.push(vscode.commands.registerCommand('_asciidoc.revealLine', function (uri, line) {
